    ...
    public class Zodiac
    {
        ...
        public static Zodiac GetZodiacSign(DateTime birthDate)
        {
            ...
            switch (birthDate.Month) {
                case 1:
                    if (birthDate.Day < 20) return CAPRICORN; return AQUARIUS;
                case 2:
                    if (birthDate.Day < 19) return AQUARIUS; return PISCES;
                case 3:
                    if (birthDate.Day < 21) return PISCES; return ARIES;
                case 4:
                    if (birthDate.Day < 20) return ARIES; return TAURUS;
                case 5:
                    if (birthDate.Day < 21) return TAURUS; return GEMINI;
                case 6:
                    if (birthDate.Day < 21) return GEMINI; return CANCER;
                case 7:
                    if (birthDate.Day < 23) return CANCER; return LEO;
                case 8:
                    if (birthDate.Day < 23) return LEO; return VIRGO;
                case 9:
                    if (birthDate.Day < 23) return VIRGO; return LIBRA;
                case 10:
                    if (birthDate.Day < 23) return LIBRA; return SCORPIO;
                case 11:
                    if (birthDate.Day < 22) return SCORPIO; return SAGITTARIUS;
                case 12:
                    if (birthDate.Day < 22) return SAGITTARIUS; return CAPRICORN;
                default:
