...
namespace CSharp.Activity.Profile
{
    ...
    public class PlayerProfile
    {
        ...
        public int ComputeAge()
        {
            ...
            int tempAge;
            if (birthdayMonth == currentMonth && birthdayDay <= currentDayOfMonth)
            {
            ...
            if (birthdayDay > currentDayOfMonth && birthdayMonth > currentMonth && birthdayYear > currentYear)
            {
                tempAge = -1; // default value - invalid age 
            }
